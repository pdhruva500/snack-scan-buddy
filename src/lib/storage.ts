...
import { buildCsv, downloadCsv as downloadCsvFile, getLogsExportFilename, padCsvHeaders } from './csvExport';
...
export const exportLogsToCSV = async (): Promise<string> => {
  ...
  return buildCsv(padCsvHeaders(headers, [24, 42, 28, 16]), rows);
};
